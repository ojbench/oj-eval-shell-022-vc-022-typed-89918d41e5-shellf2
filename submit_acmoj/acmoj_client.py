...
def main():
    ...
    subparsers.add_parser("status", help="Check submission status").add_argument("--submission-id", type=int, required=True, help="Submission ID")
    subparsers.add_parser("abort", help="Abort submission evaluation").add_argument("--submission-id", type=int, required=True, help="Submission ID")
